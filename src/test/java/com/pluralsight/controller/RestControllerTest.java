...
public class RestControllerTest {
	...
	public void testCreateRide() {
		...
		Ride ride = new Ride();
		/*Ride ride2 = new Ride();
		ride2.setName("lala Trail");
		ride2.setDuration(30);*/
		
		ride.setName("Go for Ride");
		ride.setDuration(55);
	...
	public void testUpdateRide(){
		...
		Ride ride = restTemplate.getForObject("http://localhost:8080/ride_tracker/ride/55", Ride.class);
	...
	public void testDelete(){
		...
		restTemplate.delete("http://localhost:8080/ride_tracker/delete/54");
